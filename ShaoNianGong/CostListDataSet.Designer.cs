...
namespace ShaoNianGong.CostListDataSetTableAdapters {
    ...
    public partial class CostListTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT course_types.CourseTypeName, course_subtypes.CourseSubtypeName, 
      courses.CourseName, courses.ChargeAmount, charge_type.ChargeTypeName, 
      students.Name, student_cost.CostDate, student_cost.CostAmount, students.Balance, 
      student_courses.ExpireTime, student_cost.DiscountLevel, 
      student_cost.ActualCostAmount, student_cost.DiscountReason, 
...
FROM student_cost INNER JOIN
      ...
      student_courses ON students.ID = student_courses.StudentID AND 
      courses.ID = student_courses.CourseID INNER JOIN
      discount_level ON 
      student_cost.DiscountLevel = discount_level.DiscountLevel
ORDER BY student_cost.CostDate DESC";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT course_types.CourseTypeName, course_subtypes.CourseSubtypeName, 
      courses.CourseName, courses.ChargeAmount, charge_type.ChargeTypeName, 
      students.Name, student_cost.CostDate, student_cost.CostAmount, students.Balance, 
      student_courses.ExpireTime, student_cost.DiscountLevel, 
      student_cost.ActualCostAmount, student_cost.DiscountReason, 
...
FROM student_cost INNER JOIN
      ...
      discount_level ON 
      student_cost.DiscountLevel = discount_level.DiscountLevel
WHERE (student_cost.CostDate > @BeginDate)
ORDER BY student_cost.CostDate DESC";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@BeginDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "CostDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT course_types.CourseTypeName, course_subtypes.CourseSubtypeName, 
      courses.CourseName, courses.ChargeAmount, charge_type.ChargeTypeName, 
      students.Name, student_cost.CostDate, student_cost.CostAmount, students.Balance, 
      student_courses.ExpireTime, student_cost.DiscountLevel, 
      student_cost.ActualCostAmount, student_cost.DiscountReason, 
...
ORDER BY student_cost.CostDate DESC";
            ...
            this._commandCollection[3].CommandText = @"SELECT course_types.CourseTypeName, course_subtypes.CourseSubtypeName, 
      courses.CourseName, courses.ChargeAmount, charge_type.ChargeTypeName, 
      students.Name, student_cost.CostDate, student_cost.CostAmount, students.Balance, 
      student_courses.ExpireTime, student_cost.DiscountLevel, 
      student_cost.ActualCostAmount, student_cost.DiscountReason, 
...
ORDER BY student_cost.CostDate DESC";
            ...
            this._commandCollection[4].CommandText = @"SELECT course_types.CourseTypeName, course_subtypes.CourseSubtypeName, 
      courses.CourseName, courses.ChargeAmount, charge_type.ChargeTypeName, 
      students.Name, student_cost.CostDate, student_cost.CostAmount, students.Balance, 
      student_courses.ExpireTime, student_cost.DiscountLevel, 
      student_cost.ActualCostAmount, student_cost.DiscountReason, 
...
FROM users INNER JOIN
      ...
      users.UserName = users_course_privilege.UserName INNER JOIN
...
ORDER BY student_cost.CostDate DESC";
            ...
            this._commandCollection[5].CommandText = @"SELECT course_types.CourseTypeName, course_subtypes.CourseSubtypeName, 
      courses.CourseName, courses.ChargeAmount, charge_type.ChargeTypeName, 
      students.Name, student_cost.CostDate, student_cost.CostAmount, students.Balance, 
      student_courses.ExpireTime, student_cost.DiscountLevel, 
      student_cost.ActualCostAmount, student_cost.DiscountReason, 
...
FROM users INNER JOIN
      ...
      discount_level ON student_cost.DiscountLevel = discount_level.DiscountLevel ON 
      users_course_privilege.CourseId = courses.ID
WHERE (users.UserName = @UserName) AND (student_cost.CostDate > @BeginDate)
ORDER BY student_cost.CostDate DESC";
            ...
            this._commandCollection[5].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@BeginDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "CostDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[6].Connection = this.Connection;
            this._commandCollection[6].CommandText = @"SELECT course_types.CourseTypeName, course_subtypes.CourseSubtypeName, 
      courses.CourseName, courses.ChargeAmount, charge_type.ChargeTypeName, 
      students.Name, student_cost.CostDate, student_cost.CostAmount, students.Balance, 
      student_courses.ExpireTime, student_cost.DiscountLevel, 
      student_cost.ActualCostAmount, student_cost.DiscountReason, 
...
FROM users INNER JOIN
      ...
      discount_level ON student_cost.DiscountLevel = discount_level.DiscountLevel ON 
      users_course_privilege.CourseId = courses.ID
WHERE (users.UserName = @UserName) AND (student_cost.CostDate > @BeginDate) AND 
      (student_cost.CostDate < @EndDate)
ORDER BY student_cost.CostDate DESC";
            ...
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@BeginDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "CostDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@EndDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "CostDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByBeginDate(CostListDataSet.CostListDataTable dataTable, System.DateTime BeginDate) {
        ...
        public virtual CostListDataSet.CostListDataTable GetDataByBeginDate(System.DateTime BeginDate) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(BeginDate));
            CostListDataSet.CostListDataTable dataTable = new CostListDataSet.CostListDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUserNameBeginDate(CostListDataSet.CostListDataTable dataTable, string UserName, System.DateTime BeginDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual CostListDataSet.CostListDataTable GetDataByUserNameBeginDate(string UserName, System.DateTime BeginDate) {
            this.Adapter.SelectCommand = this.CommandCollection[5];
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUserNameBeginEndDate(CostListDataSet.CostListDataTable dataTable, string UserName, System.DateTime BeginDate, System.DateTime EndDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual CostListDataSet.CostListDataTable GetDataByUserNameBeginEndDate(string UserName, System.DateTime BeginDate, System.DateTime EndDate) {
            this.Adapter.SelectCommand = this.CommandCollection[6];
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
