...
namespace ShaoNianGong.UsersTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [users] SET [UserName] = @UserName, [Password] = @Password, [UserType] = @" +
                "UserType WHERE (([UserName] = @Original_UserName) AND ([Password] = @Original_Pa" +
                "ssword) AND ([UserType] = @Original_UserType))";
        ...
        public virtual int UpdateUserPwd(string Password, string Original_UserName) {
