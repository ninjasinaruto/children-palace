...
namespace ShaoNianGong
{
    public class Money
    {
        ...
        public string Convert(bool isNeedUnit)
        {
            string bb = "";
            if (IsNumber)
            {
                string str = j.ToString("00000.00");
            ...
            if (!isNeedUnit)
                bb = bb.Replace("万", "").Replace("仟", "").Replace("佰", "").Replace("拾", "").Replace("元", "").Replace("角", "").Replace("分", "").Replace("整","");
            return bb;
        }
