...
namespace ShaoNianGong
{
    public partial class LoginForm : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            DataRow[] rows = usersDataSet._Users.Select("UserName = '" + txtUserName.Text.Trim() + "'");
            ...
            this.UserType = rows[0].Field<int>("UserType");
        ...
        {
            // TODO: 这行代码将数据加载到表“usersDataSet._Users”中。您可以根据需要移动或删除它。
