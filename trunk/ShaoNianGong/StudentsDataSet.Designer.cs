...
WHERE (students.Status > 0) AND (courses.ID = @CourseID)";
            ...
            this._commandCollection[2].CommandText = @"SELECT students.Name, students.Sex, students.Telephone, students.Address, 
      students.Birthday, students.FartherName, students.FartherWork, students.FartherTel, 
      students.MotherName, students.MotherWork, students.MotherTel, students.CardNo, 
      students.Balance, students.Status, students.ID, card_type.CardTypeName, 
      student_status.StatusName, courses.CourseName, 
...
WHERE   (course_time.CourseID = @CourseID)";
    ...
    public partial class StudentCostTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO student_cost\r\n      (StudentID, CourseID, CostAmount, CostDate, Disco" +
