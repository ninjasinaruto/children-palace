...
FROM students INNER JOIN
      ...
      tearchers ON courses.TeacherID = tearchers.ID";
            ...
            this._commandCollection[3].CommandText = "SELECT DISTINCT \r\n                StudentsID, Name, Sex, Telephone, Address, Birt" +
                ...
                "               student_status ON students.Status = student_status.StatusID LEFT " +
                "OUTER JOIN\r\n                                 student_courses ON student_courses." +
                "ID =\r\n                                     (SELECT   MIN(ID) AS Expr1\r\n         " +
                "                             FROM      student_courses\r\n                        " +
                "              WHERE   (StudentID = students.ID)) LEFT OUTER JOIN\r\n              " +
                "                   courses ON courses.ID = student_courses.CourseID LEFT OUTER J" +
                "OIN\r\n                                 tearchers ON tearchers.ID = courses.Teache" +
                "rID\r\n                 WHERE   (students.Status = 2)\r\n                 UNION ALL\r" +
                "\n                 SELECT   students_1.ID AS StudentsID, students_1.Name, student" +
                "s_1.Sex, students_1.Telephone, students_1.Address, \r\n                           " +
                "      students_1.Birthday, students_1.FartherName, students_1.FartherWork, stude" +
                "nts_1.FartherTel, \r\n                                 students_1.MotherName, stud" +
                "ents_1.MotherWork, students_1.MotherTel, students_1.CardNo, \r\n                  " +
                "               students_1.Balance, students_1.Status, students_1.ID, students_1." +
                "ExpireTime, card_type_1.CardTypeName, \r\n                                 student" +
                "_status_1.StatusName, courses_1.CourseName, tearchers_1.Name AS teacherName\r\n   " +
                "              FROM      students AS students_1 INNER JOIN\r\n                     " +
                "            card_type AS card_type_1 ON students_1.CardType = card_type_1.CardTy" +
                "peID INNER JOIN\r\n                                 student_status AS student_stat" +
                "us_1 ON students_1.Status = student_status_1.StatusID LEFT OUTER JOIN\r\n         " +
                "                        student_courses AS student_courses_1 ON student_courses_" +
                "1.ID =\r\n                                     (SELECT   MIN(ID) AS Expr1\r\n       " +
                "                               FROM      student_courses\r\n                      " +
                "                WHERE   (StudentID = students_1.ID)) LEFT OUTER JOIN\r\n          " +
                "                       courses AS courses_1 ON courses_1.ID = student_courses_1." +
                "CourseID LEFT OUTER JOIN\r\n                                 tearchers AS tearcher" +
                "s_1 ON tearchers_1.ID = courses_1.TeacherID\r\n                 WHERE   (students_" +
                "1.ID IN\r\n                                     (SELECT   StudentID\r\n             " +
                "                         FROM      student_refund))) AS t\r\nORDER BY Status, Stud" +
                "entsID";
