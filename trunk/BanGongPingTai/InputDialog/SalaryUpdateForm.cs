...
namespace BanGongPingTai
{
    public partial class SalaryUpdateForm : Form
    {
        ...
        {
            this.teacherSalaryLogTableAdapter.FillByThisMonthNotLogIDWithTeacherID(this.teacherWageDataSet.TeacherSalaryLog, dtpBasic.Value, TeacherID, LogID);
